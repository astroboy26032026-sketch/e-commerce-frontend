...
// internal
import laptop from '@/assets/images/login/laptop.png';
import man from '@/assets/images/login/man.png';
import shape_1 from '@/assets/images/login/shape-1.png';
import shape_2 from '@/assets/images/login/shape-2.png';
import shape_3 from '@/assets/images/login/shape-3.png';
import shape_4 from '@/assets/images/login/shape-4.png';
